...
```mermaid
graph TD
    SN[ServiceNow Instance] -->|REST| sn_upgrade_preview_validator
    sn_upgrade_preview_validator -->|Store| DB[ServiceNow Tables]
    sn_upgrade_preview_validator -->|Output| Report[MD/JSON Reports]
```
## Installation
```bash
...
```
## ROI Calculator
| Metric | Manual | With sn_upgrade_preview_validator |
|--------|--------|-------------|
...
## Overview
sn_upgrade_preview_validator is a production-grade ServiceNow scoped application developed by Vladimir Kapustin under AGPL-3.0.

## Architecture
```mermaid
graph TD
    SN[ServiceNow Instance] -->|REST| sn_upgrade_preview_validator
    sn_upgrade_preview_validator -->|Store| DB[x_sn_upgrade_preview_validator_tables]
    sn_upgrade_preview_validator -->|Output| Report[Reports MD/JSON/CSV]
...
## ROI Analysis
| Metric | Manual Process | With sn_upgrade_preview_validator |
|--------|---------------|-------------|
...
See `Validation/TEST CASES/sn_upgrade_preview_validator/test_suite_SOP.md`
...
- ServiceNow Community: Tag `sn_upgrade_preview_validator`
